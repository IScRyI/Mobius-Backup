...
_Bool Initialisation_zone_central(SDL_Renderer *renderer);
_Bool Creation_zone_bouton_gestion_fenetre(SDL_Renderer *renderer_fenetre,SDL_Texture *bouton_gestion_fenetre);
_Bool Creation_zone_lecteur(SDL_Renderer *renderer_fenetre);
_Bool Bande_lateral_gauche(SDL_Renderer *renderer_fenetre);
